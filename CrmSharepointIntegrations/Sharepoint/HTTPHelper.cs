...
namespace CrmSharepointIntegrations
{
    ...
    public static class HttpHelper
    {
        ...
        /// <param name="clientHandler">The request client handler</param>
        /// <param name="headers">The http headers to append to the request</param>
        public static HttpWebResponseExt SendHttpRequest(Uri uri, String method, byte[] requestContent = null, string contentType = null, HttpWebRequest clientHandler = null, Dictionary<string, string> headers = null)
        {
            HttpWebResponseExt result = new HttpWebResponseExt();
    ...
    public class HttpWebResponseExt
    {
        ...
        public bool Success {
            get
            {
                ...
                return (status >= 200 && status < 300); // All 2** status codes are Success codes as per REST guidelines.http://www.restapitutorial.com/httpstatuscodes.html
            }
        }
    }
